...
export default class RenderableObject {
  ...
  render(
    ...
    const materialShininessLocation = gl.getUniformLocation(
      this.shaderProgram.program,
      'u_material.Shininess'
    );
    const materialAmbientColorLocation = gl.getUniformLocation(
      this.shaderProgram.program,
      'u_material.AmbientColor'
    );
    const materialDiffuseColorLocation = gl.getUniformLocation(
      this.shaderProgram.program,
      'u_material.diffuseColor'
    );
    const materialSpecularColorLocation = gl.getUniformLocation(
      this.shaderProgram.program,
      'u_material.SpecularColor'
    );
    const materialEmissiveColorLocation = gl.getUniformLocation(
      this.shaderProgram.program,
      'u_material.EmissiveColor'
    );
    const materialDensityLocation = gl.getUniformLocation(
      this.shaderProgram.program,
      'u_material.Density'
    );
    const materialTransparencyLocation = gl.getUniformLocation(
      this.shaderProgram.program,
      'u_material.Transparency'
    );
